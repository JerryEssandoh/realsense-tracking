...
ecal_rec_client --whitelist "MeshAndTouchdownMessage,PoseMessage,RGBDLandingMessage,RGBDMessage,TouchdownMessage,LandingMessage" -d /home/a2sys/ecalmeas -n "$timestamp" -r
